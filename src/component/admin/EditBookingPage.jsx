    ...
    const acheiveBooking = async (bookingId) => {
        ...
        try {
            ...
            if (response.statusCode === 200) {
                ...
                setTimeout(() => {
                    setSuccessMessage('');
                    navigate('/admin/manage-housemaid-bookings');
                }, 3000);
            }
        } catch (error) {
        ...
        <div className="find-booking-page">
            ...
            {bookingDetails && (
                <div className="booking-details">
                    <h3>Housemaid Details</h3>
                    <p>Confirmation Code: {bookingDetails.bookingConfirmationCode}</p>
                    <p>Check-in Date: {bookingDetails.checkInDate}</p>
                    <p>Check-out Date: {bookingDetails.checkOutDate}</p>
                    <p>Num Of Houses: {bookingDetails.numOfAdults}</p>
                    ...
                    <div>
                        ...
                        <p> Housemaid recruit/book Price: ${bookingDetails.room.roomPrice}</p>
                        <p> Housemaid Description: {bookingDetails.room.roomDescription}</p>
