...
const HousemaidSearch = ({ handleSearchResult }) => {
    ...
    try {
      ...
      if (response.statusCode === 200) {
        if (response.roomList.length === 0) {
          showError('housemaid not currently available for this date range on the selected housemaid type.');
          return
        }
    ...
    <section>
      <div className="search-container">
        <div className="search-field">
          <label>Check-in Date(startig date you want housemaid)</label>
          <DatePicker
            selected={startDate}
        ...
        <div className="search-field">
          <label>Check-out Date(date when housemaid return)</label>
          <DatePicker
            selected={endDate}
...
export default HousemaidSearch;
